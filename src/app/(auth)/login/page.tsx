      ...
      <div className="flex flex-col gap-4">
        ...
        <form onSubmit={handleCredentials} className="flex flex-col gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-1 rounded-lg bg-zinc-900 dark:bg-white px-4 py-2 text-sm font-semibold text-white dark:text-zinc-900 hover:bg-zinc-700 dark:hover:bg-zinc-200 disabled:opacity-50"
          >
